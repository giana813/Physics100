...
def calculate_vectors(RA1,Dec1,t1,RA2,Dec2,t2,RA3,Dec3,t3,R1,R2,R3,R1dot,R2dot,R3dot):
    ...
    eps = (23.5*pi)/180
    rmatrix = numpy.matrix([[r2[0]],[r2[1]],[r2[2]]])
    rdotmatrix = numpy.matrix([[rdot_new[0]],[rdot_new[1]],[rdot_new[2]]])
    transformmatrix = numpy.matrix([[1,0,0],[0,cos(eps),sin(eps)],[0,-sin(eps),cos(eps)]])
...
data = [
    [9, 5, 2024, 6, 40, 22.89], #obs 1: day, month, year, hh, mm, ss
    [16, 35, 42.15, 24, 48, 40.32], #obs 1: raH, raM, raS, decD, decaM, decaS
    [6.650093290146021E-01,7.596666498605855E-01,-7.379457696819092E-05, #obs 1: sun x, y, z
     -1.276306774338586E-02,1.157771047485068E-02,-7.677017270953026E-05], #obs1: sun vx, vy, vz
    [16, 5, 2024, 6, 23, 31.15],
    [16, 30, 9.1, 25, 43, 16.96],
    [5.720048921176163E-01, 8.337938495389156E-01, -7.811934269078031E-05,
     -1.401012430775391E-02, 9.964889123785846E-03, -7.580892067011969E-05],
    [23, 5, 2024, 4, 33, 17.41],
    [16, 24, 20.98, 26, 26, 36.93],
    [4.720405525067897E-01, 8.957150814609939E-01, -8.028838184678356E-05, 
     -1.496120064987735E-02, 8.276392077830879E-03, -8.504375071362869E-05],
]
